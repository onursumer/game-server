...
/**
 * This aspect maintains (on the server side) synchronization of incoming
 * requests from the multiple clients. The produced commands are
...
public aspect ProducerAspect
{
	...
	/**
	 * Inner ComsumerThread which forwards commands to server controller.
	 * 
	 * @author Selcuk Onur Sumer
	 *
	 */
